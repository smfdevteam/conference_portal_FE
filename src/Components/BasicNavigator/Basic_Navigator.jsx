...
const Basic_Navigator = () => {
  ...
  return (
    <>
      <div className="my-5 grid  grid-cols-4 justify-center items-center">
        <div onClick={()=>navigate('/materials')} className="flex flex-col hover:translate-y-[-5px] hover:scale-110 transition items-center justify-center">
        ...
        <div onClick={()=>navigate('/song')} className="flex flex-col hover:translate-y-[-5px] hover:scale-110 transition items-center justify-center">
