  ...
  const handleShare = () => {
    if (navigator.share) {
      navigator.share({
        ...
        text :"صاحبك عمل شير معاك للبروفايل الخاص بيه علي أبليكشن المؤتمر , دلوقتي تدقر تكتبله رسالة و كمان تشوف لو عامل شير لكتابات ليه هو  شاركها معااصحابه في المؤتمر"
      });
    }
  };
